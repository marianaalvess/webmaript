window.i18n = (function () {
  const main = {
    ...
    en: {
      ...
      "hero.pill": "Premium Web Development",
      "hero.h1.a": "Digital Presence",
      "hero.h1.b": "of global",
      "hero.h1.c": "impact.",
      "hero.sub1": "High-performance websites, technical SEO, and full compliance (GDPR). Designed in Portugal for companies that demand excellence.",
      "hero.sub2": "No slow templates. Just clean code and measurable results.",
      "hero.chip1": "100% Performance",
      "hero.chip2": "International SEO",
      "hero.chip3": "Premium Support",
    ...
    es: {
      ...
      "hero.pill": "Desarrollo Web Premium",
      "hero.h1.a": "Presencia Digital",
      "hero.h1.b": "de impacto",
      "hero.h1.c": "global.",
      "hero.sub1": "Sitios web de alto rendimiento, SEO técnico y cumplimiento total (RGPD). Diseñados en Portugal para empresas que exigen excelencia.",
      "hero.sub2": "Sin plantillas lentas. Solo código limpio y resultados medibles.",
      "hero.chip1": "Rendimiento 100%",
      "hero.chip2": "SEO Internacional",
      "hero.chip3": "Soporte Premium",
    ...
    de: {
      ...
      "hero.pill": "Premium-Webentwicklung",
      "hero.h1.a": "Digitale Präsenz",
      "hero.h1.b": "mit globaler",
      "hero.h1.c": "Wirkung.",
      "hero.sub1": "Hochperformante Websites, technisches SEO und volle Compliance (DSGVO). In Portugal für Unternehmen entwickelt, die Exzellenz fordern.",
      "hero.sub2": "Keine langsamen Templates. Nur sauberer Code und messbare Ergebnisse.",
      "hero.chip1": "100% Performance",
      "hero.chip2": "Internationales SEO",
      "hero.chip3": "Premium-Support",
    ...
    zh: {
      ...
      "hero.h1.b": "数字",
      "hero.h1.c": "形象。",
      "hero.sub1": "高性能网站、技术 SEO 以及全面合规（GDPR）。在葡萄牙为力求卓越的企业设计。",
      "hero.sub2": "没有缓慢的模板。只有简洁的代码和看得见的成果。",
      "hero.chip1": "100% 性能",
      "hero.chip2": "国际 SEO",
      "hero.chip3": "尊享支持",
      "hero.chip4": "多语言",
  ...
  Object.keys(chat).forEach(lang => {
    if (main[lang]) {
      Object.assign(main[lang], chat[lang]);
    } else {
      main[lang] = chat[lang];
    }
  });
