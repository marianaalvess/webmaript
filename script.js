(() => {
  ...
  const initChatbot = () => {
    ...
    const handleAction = (action) => {
      ...
      if (action === "scroll_portfolio") {
        ...
        // Low budget
        window.open(`https://wa.me/${phone}?text=${encodeURIComponent("Ol�, tenho um or�amento reduzido (<400�) mas gostaria de conversar.")}`, "_blank");
  ...
  // NOTE: servi�os (#servicos) layout is controlled via CSS (.services__grid) to match screenshot.
